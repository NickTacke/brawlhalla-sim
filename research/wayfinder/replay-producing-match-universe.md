...
console.log(JSON.stringify({
  ...
  scoringTypeIds: unique(replays.map((replay) => replay.gameSettings.scoringTypeId)),
  durations: unique(replays.map((replay) => replay.gameSettings.duration)),
  maxPlayers: unique(replays.map((replay) => replay.gameSettings.maxPlayers)),
  variations: unique(replays.map((replay) => replay.gameSettings.variation)),
